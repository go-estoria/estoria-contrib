...
func databasePerStreamEventDocumentFromEvent(evt *eventstore.Event, version int64) databasePerStreamEventDocument {
...
func (d databasePerStreamEventDocument) ToEvent(streamID typeid.UUID) (*eventstore.Event, error) {
